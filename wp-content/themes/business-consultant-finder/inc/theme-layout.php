     ...
     <?php
      ...
      <div class="site-info">
    	<?php
                ...
                printf( esc_html__( 'Theme %3$s By %1$s - Proudly powered by %2$s .', 'business-consultant-finder' ), '<a href="https://athemeart.com" target="_blank" rel="nofollow">aThemeArt</a>', '<a href="https://www.wordpress.org/themes/business-consultant-finder/" target="_blank" rel="nofollow">WordPress</a>','<a href="https://athemeart.com/downloads/business-consultant-finder/" rel="nofollow" target="_blank">BCF</a>' );
                ?>
      </div>
